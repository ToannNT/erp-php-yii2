...
use api\modules\v1\frontend\location\models\Ward;

/**
 * WardSearch represents the model behind the search form of `api\modules\v1\frontend\location\models\Ward`.
 */
class WardSearch extends Ward
{
    ...
    {
        return [
            [['code', 'name', 'name_en', 'full_name', 'full_name_en', 'code_name', 'district_code'], 'safe'],
