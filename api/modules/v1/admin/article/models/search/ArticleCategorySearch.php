...
namespace api\modules\v1\admin\article\models\search;
...
/**
 * ArticleCategorySearch represents the model behind the search form of `api\modules\v1\admin\article\models\ArticleCategory`.
 */
