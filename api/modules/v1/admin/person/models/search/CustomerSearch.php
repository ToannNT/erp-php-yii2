...
use api\modules\v1\admin\person\models\Customer as CustomerModel;

/**
 * Customer represents the model behind the search form about `api\modules\v1\admin\person\models\Customer`.
 */
class CustomerSearch extends CustomerModel
{
    ...
    {
        $query = CustomerModel::find()->notDelete();
