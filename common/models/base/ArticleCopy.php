...
/**
 * This is the base-model class for table "article_copy".
 *
 * @property integer $id
 ...
 */
abstract class ArticleCopy extends \common\models\base\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \common\models\ArticleCategory::class, 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasOne(\common\models\ArticleCategory::class, ['id' => 'category_id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \common\models\ArticleCopyQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\ArticleCopyQuery(get_called_class());
    }
