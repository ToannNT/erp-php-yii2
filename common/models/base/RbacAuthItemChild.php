...
abstract class RbacAuthItemChild extends \common\models\base\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['parent'], 'exist', 'skipOnError' => true, 'targetClass' => \common\models\RbacAuthItem::class, 'targetAttribute' => ['parent' => 'name']],
            [['child'], 'exist', 'skipOnError' => true, 'targetClass' => \common\models\RbacAuthItem::class, 'targetAttribute' => ['child' => 'name']]
        ];
    }
    ...
    {
        return $this->hasOne(\common\models\RbacAuthItem::class, ['name' => 'child']);
    }
    ...
    {
        return $this->hasOne(\common\models\RbacAuthItem::class, ['name' => 'parent']);
    }
