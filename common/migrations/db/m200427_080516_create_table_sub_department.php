...
/**
 * Class m200427_080516_create_table_sub_department
 */
class m200427_080516_create_table_sub_department extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function up()
    {
        $this->createTable('{{%sub_department}}', [
            ...
            'department_id' => $this->integer()->comment('Office ID'),
    ...
    public function down()
    {
        echo "m200427_080516_create_table_sub_department cannot be reverted.\n";
